...
if __name__ == '__main__':
	tensorFirst = torch.FloatTensor(cv2.imread(arguments_strFirst).transpose(2, 0, 1).astype(numpy.float32) * (1.0 / 255.0))
	tensorSecond = torch.FloatTensor(cv2.imread(arguments_strSecond).transpose(2, 0, 1).astype(numpy.float32) * (1.0 / 255.0))
